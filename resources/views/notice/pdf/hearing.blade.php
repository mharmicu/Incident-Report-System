...
<body style=" font-family: 'Times New Roman', serif !important;">
    ...
    <div class="container-fluid">
        <div class="text-center">
            <img src="{{public_path('img/tanyaglogo.png')}}" style="width:150px; height:150px" class="rounded img-fluid" alt="Barangay Tanyag"> <br><br>
        </div>
        <div class="row">
